# IP2Location.io Dart API

## Configuration Class

```{py:function} Configuration(apiKey)
...
```{py:function} IPGeolocation(config)
...
:::
:return: Returns the geolocation information in map. Refer below table for the fields avaliable in the map
:rtype: map
...
:return: IP2WHOIS Domain WHOIS result in map. Refer below table for the fields avaliable in the map.
:rtype: map
...
```{py:function} HostedDomain(config)
...
:return: Returns the hosted domains information in map. Refer below table for the fields avaliable in the map
:rtype: map
