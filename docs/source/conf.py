...
myst_html_meta = {
    "description": "IP2Location.io Dart library allows user to query for an enriched data set based on IP address and provides WHOIS lookup api that helps users to obtain domain information.",
    "keywords": "IP2Location, Geolocation, IP location, Dart, WHOIS, domain, hosted domains",
...
html_title = "IP2Location.io Dart SDK"

# html_baseurl = "https://ip2location-io-dart.readthedocs.io/en/latest/"