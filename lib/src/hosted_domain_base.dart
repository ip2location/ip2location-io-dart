...
/// This class performs the lookup of hosted domains data from an IP address
/// by querying the IP2Location.io API.
class HostedDomain {
  static const String _baseUrl = 'https://domains.ip2whois.com/domains';
  static const String _format = 'json';
  static const String _error = 'HostedDomain lookup error.';
